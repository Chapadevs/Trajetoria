  ...
  en: {
    translation: {
      ...
      reportPdf: {
        ...
        anamneseTitle: 'Anamnesis - General Data',
        ...
        dash: '—',
        discTitle: 'DISC Insight - Personality Profile',
        yourProfile: 'Your Profile',
        dominance: 'Dominance',
        influence: 'Influence',
        steadiness: 'Steadiness',
        conscientiousness: 'Conscientiousness',
        dominancePct: '{{pct}}% dominance',
        discD: 'Dominance (D)',
        discI: 'Influence (I)',
        discS: 'Steadiness (S)',
        discC: 'Conscientiousness (C)',
        multipleIntelligences: 'Multiple Intelligences',
        miEspacial: 'Spatial',
        miLogica: 'Logical-Mathematical',
        miLinguistica: 'Linguistic',
        miMusical: 'Musical',
        miCorporal: 'Bodily-Kinesthetic',
        miInterpessoal: 'Interpersonal',
        miIntrapessoal: 'Intrapersonal',
        miNaturalista: 'Naturalist',
        riasecTitle: 'RIASEC - Career Orientation',
        riasecR: 'Realistic',
        ...
        archetypesTitle: 'Personality Archetypes',
        archInocente: 'The Innocent',
        archSabio: 'The Sage',
        archExplorador: 'The Explorer',
        archForaDaLei: 'The Outlaw',
        archMago: 'The Magician',
        archHeroi: 'The Hero',
        archAmante: 'The Lover',
        archBobo: 'The Jester',
        archCaraComum: 'The Everyman',
        archCuidador: 'The Caregiver',
        archGovernante: 'The Ruler',
        archCriador: 'The Creator',
        direction: 'Direction:',
        target: 'Target:',
        impulse: 'Impulse:',
        path: 'Path:',
        highlightsTitle: 'JOURNEY HIGHLIGHTS',
        navigationStyle: 'The Navigation Style',
        terrainOfSkills: 'The Terrain of Skills',
        mapOfPossibilities: 'The Map of Possibilities',
        essenceOfWalker: 'The Essence of the Walker',
        actionRoutesTitle: 'ACTION ROUTES',
        threePathsSubtitle: 'Three Possible Paths',
        conclusionsTitle: 'CONCLUSIONS',
        destinoHeading: 'The Destination is the Path',
        finalMessageTitle: 'TRAJETÓRIA Final Message:',
        nextStepsTitle: 'Next Steps',
        sectionDestino: 'The Destination is the Path',
        sectionFinalMessage: 'TRAJETÓRIA Final Message',
        sectionNextSteps: 'Next Steps',
        fallbackBody: '{{prefix}}Remember: the purpose of your journey is to find direction and meaning, step by step. This report is not the end point, but the beginning of a conscious path toward a future aligned with your essence.',
        fallbackFinalMsg: 'Believe in your ability to make a difference. Every step counts toward becoming a protagonist of impact.',
        fallbackNextStep1: 'Review your results regularly to track your progress.',
        fallbackNextStep2: 'Use this information to guide your career decisions.',
        fallbackNextStep3: 'Seek opportunities aligned with your strengths.',
        fallbackNextStep4: 'Develop areas you wish to strengthen.',
        fallbackNextStep5: 'Share your results with mentors or career coaches.',
        direcaoTemplate: 'Your motivation is guided by {{arch}} and the {{disc}} style, seeking to make a difference with consistency.',
        alvoTemplate: 'Your highlights combine {{mi}} with interests in {{riasec}} — great for interacting, solving problems and learning continuously.',
        impulsoTemplate: 'Growth potential lies in using {{mi}} to leverage projects aligned with {{riasec}}, maintaining focus and pace.',
        pathTemplate: 'Technology, entrepreneurship and related areas offer opportunities consistent with your values; prioritize paths that combine {{mi}} and {{riasec}}.',
        estiloTemplate: 'Your behavioral profile, with a predominance in {{disc}}, indicates that you navigate with charisma and sociability. Your ability to communicate and connect people is a differentiator in any professional path.',
        terrenoTemplate: 'Your multiple intelligences, especially {{mi1}} and {{mi2}}, are the fertile ground where your potential can flourish. You learn quickly and turn ideas into collaboration and innovation.',
        mapaTemplate: 'In RIASEC, {{r1}} and {{r2}} stand out. This suggests you enjoy solving problems based on evidence and creating practical solutions with real impact.',
        essenciaTemplate: 'With archetypes like {{arch}}, your essence combines knowledge, exploration and freedom to create. You have a vocation for stories of discovery and transformation, inspiring people around you.',
        route1Template: 'Combining your {{mi1}} and {{mi2}} intelligences, work on projects that impact society. Use your empathy and organization to mobilize stakeholders and drive change.',
        route2Template: 'Leverage your {{r1}} and {{r2}} profile to implement new ideas. Analyze data, run experiments and pilot solutions that unlock results in organizations.',
        route3Template: 'If your combination of {{mi}} and practical vision speaks loudly, create lean digital solutions for real problems. The agile, flexible tech environment fits your profile.',
        actionRoute1Title: 'Social Project Management:',
        actionRoute2Title: 'Innovation Consulting:',
        actionRoute3Title: 'Technology Entrepreneurship:',
        actionStep1: 'Identify learning opportunities aligned with your profile.',
        actionStep2: 'Explore areas that combine innovation and flexibility.',
        actionStep3: 'Develop skills that complement your strengths.',
        actionStep4: 'Seek feedback to adjust direction and accelerate goals.',
        actionStep5: 'Start a pilot project that combines your strengths and interests.',
      },
      completedAssessments: {
        reportReadyTitle: 'Your complete report is ready',
        reportReadySubtitle: 'Review all the insights you have gained so far and generate a PDF with personalized recommendations.',
        reportIncludesLabel: 'The report includes:',
        itemAnamnese: 'Complete initial anamnesis',
        itemDisc: 'Detailed DISC analysis',
        itemMi: 'Multiple Intelligences profile',
        itemRiasec: 'Holland Code (RIASEC)',
        itemArchetypes: 'Personality Archetypes',
        itemRecommendations: 'Personalized recommendations',
        allComplete: 'All tests completed!',
        continueToComplete: 'Continue to complete your report.',
        privacyNote: 'The report will be generated in real time based on data saved in your browser. No information is sent to external servers permanently.',
        pending: 'Pending: {{count}} {{tests}}',
        test: 'test',
        tests: 'tests',
        generatingReport: 'Generating report...',
        downloadPdf: 'Download report as PDF',
        clearAllResults: 'Clear all saved results',
  ...
  pt: {
    translation: {
      ...
      reportPdf: {
        ...
        anamneseTitle: 'Anamnese - Dados Gerais',
        ...
        dash: '—',
        discTitle: 'DISC Insight - Perfil de Personalidade',
        yourProfile: 'Seu Perfil',
        dominance: 'Dominância',
        influence: 'Influência',
        steadiness: 'Estabilidade',
        conscientiousness: 'Conformidade',
        dominancePct: '{{pct}}% dominância',
        discD: 'Dominância (D)',
        discI: 'Influência (I)',
        discS: 'Estabilidade (S)',
        discC: 'Conformidade (C)',
        multipleIntelligences: 'Inteligências Múltiplas',
        miEspacial: 'Espacial',
        miLogica: 'Lógico-Matemática',
        miLinguistica: 'Linguística',
        miMusical: 'Musical',
        miCorporal: 'Corporal-Cinestésica',
        miInterpessoal: 'Interpessoal',
        miIntrapessoal: 'Intrapessoal',
        miNaturalista: 'Naturalista',
        riasecTitle: 'RIASEC - Orientação Profissional',
        riasecR: 'Realista',
        ...
        archetypesTitle: 'Arquétipos de Personalidade',
        archInocente: 'O Inocente',
        archSabio: 'O Sábio',
        archExplorador: 'O Explorador',
        archForaDaLei: 'O Fora da Lei',
        archMago: 'O Mago',
        archHeroi: 'O Herói',
        archAmante: 'O Amante',
        archBobo: 'O Bobo da Corte',
        archCaraComum: 'O Cara Comum',
        archCuidador: 'O Cuidador',
        archGovernante: 'O Governante',
        archCriador: 'O Criador',
        direction: 'Direção:',
        target: 'Alvo:',
        impulse: 'Impulso:',
        path: 'Caminho:',
        highlightsTitle: 'DESTAQUES DA JORNADA',
        navigationStyle: 'O Estilo de Navegação',
        terrainOfSkills: 'O Terreno de Habilidades',
        mapOfPossibilities: 'O Mapa das Possibilidades',
        essenceOfWalker: 'A Essência do Caminhante',
        actionRoutesTitle: 'ROTAS DE AÇÃO',
        threePathsSubtitle: 'Três Caminhos Possíveis',
        conclusionsTitle: 'CONCLUSÕES',
        destinoHeading: 'O Destino é o Caminho',
        finalMessageTitle: 'Mensagem Final da TRAJETÓRIA:',
        nextStepsTitle: 'Próximos Passos',
        sectionDestino: 'O Destino é o Caminho',
        sectionFinalMessage: 'Mensagem Final da TRAJETÓRIA',
        sectionNextSteps: 'Próximos Passos',
        fallbackBody: '{{prefix}}lembre-se: o propósito da sua trajetória é encontrar direção e significado, passo a passo. Este relatório não é o ponto final, e sim o início de um caminho consciente rumo a um futuro alinhado à sua essência.',
        fallbackFinalMsg: 'Acredite na sua capacidade de fazer a diferença. Cada passo conta para se tornar um protagonista de impacto.',
        fallbackNextStep1: 'Revise seus resultados com frequência para acompanhar sua evolução.',
        fallbackNextStep2: 'Use estes insights para orientar decisões de carreira.',
        fallbackNextStep3: 'Busque oportunidades alinhadas aos seus pontos fortes.',
        fallbackNextStep4: 'Desenvolva áreas que deseja fortalecer.',
        fallbackNextStep5: 'Converse com mentores ou coaches de carreira.',
        direcaoTemplate: 'Sua motivação se orienta por {{arch}} e pelo estilo {{disc}}, buscando fazer a diferença com consistência.',
        alvoTemplate: 'Seus destaques combinam {{mi}} com interesses {{riasec}} - ótimos para interagir, resolver problemas e aprender continuamente.',
        impulsoTemplate: 'O potencial de crescimento está em usar {{mi}} para alavancar projetos alinhados a {{riasec}}, mantendo foco e ritmo.',
        pathTemplate: 'Tecnologia, empreendedorismo e áreas afins oferecem oportunidades coerentes com seus valores; priorize trilhas que unam {{mi}} e {{riasec}}.',
        estiloTemplate: 'Seu perfil comportamental, com predominância em {{disc}}, indica que você navega com carisma e sociabilidade. Sua habilidade de se comunicar e conectar pessoas é um diferencial em qualquer caminho profissional.',
        terrenoTemplate: 'As suas múltiplas inteligências, especialmente a {{mi1}} e a {{mi2}}, são o terreno fértil onde seu potencial pode florescer. Você aprende rápido e transforma ideias em colaboração e inovação.',
        mapaTemplate: 'No RIASEC, destacam-se {{r1}} e {{r2}}. Isso sugere que você gosta de resolver problemas com base em evidências e criar soluções práticas com impacto real.',
        essenciaTemplate: 'Com arquétipos como {{arch}}, sua essência combina conhecimento, exploração e liberdade de criar. Você tem vocação para histórias de descoberta e transformação, inspirando pessoas ao seu redor.',
        route1Template: 'Combinando suas inteligências {{mi1}} e {{mi2}}, atue em projetos que impactem a sociedade. Use sua empatia e organização para mobilizar stakeholders e gerar transformação.',
        route2Template: 'Aproveite seu perfil {{r1}} e {{r2}} para implementar ideias novas. Analise dados, conduza experimentos e pilote soluções que destravem resultados nas organizações.',
        route3Template: 'Se sua combinação de {{mi}} e visão prática fala alto, crie soluções digitais enxutas para problemas reais. O ambiente ágil e flexível de tecnologia combina com seu perfil.',
        actionRoute1Title: 'Gestão de Projetos Sociais:',
        actionRoute2Title: 'Consultoria em Inovação:',
        actionRoute3Title: 'Empreendedorismo em Tecnologia:',
        actionStep1: 'Identifique oportunidades de aprendizado alinhadas ao seu perfil.',
        actionStep2: 'Experimente áreas que unam inovação e flexibilidade.',
        actionStep3: 'Desenvolva competências complementares aos seus destaques.',
        actionStep4: 'Busque feedbacks para ajustar direção e acelerar metas.',
        actionStep5: 'Inicie um projeto-piloto que una suas forças e interesses.',
      },
      completedAssessments: {
        reportReadyTitle: 'Seu relatório completo está pronto',
        reportReadySubtitle: 'Revise todos os insights obtidos até agora e gere um PDF com recomendações personalizadas.',
        reportIncludesLabel: 'O relatório inclui:',
        itemAnamnese: 'Anamnese inicial completa',
        itemDisc: 'Análise DISC detalhada',
        itemMi: 'Perfil de Inteligências Múltiplas',
        itemRiasec: 'Código Holland (RIASEC)',
        itemArchetypes: 'Arquétipos de Personalidade',
        itemRecommendations: 'Recomendações personalizadas',
        allComplete: 'Todos os testes completados!',
        continueToComplete: 'Continue para completar seu relatório.',
        privacyNote: 'O relatório será gerado em tempo real com base nos dados salvos no navegador. Nenhuma informação é enviada para servidores externos permanentemente.',
        pending: 'Pendentes: {{count}} {{tests}}',
        test: 'teste',
        tests: 'testes',
        generatingReport: 'Gerando relatório...',
        downloadPdf: 'Baixar relatório em PDF',
        clearAllResults: 'Limpar todos os resultados salvos',
